...
function boiler_setup() {
	...
	register_nav_menus( array(
		...
		'learn-more' => __( 'Footer Learn More Menu', 'boiler' ),
...
function boiler_scripts_styles() {
	...
	// wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/vendor/jquery-1.9.1.min.js', '20120206', true );
	...
	// wp_enqueue_script( 'classie', get_template_directory_uri() . '/js/vendor/classie.js', '20120206', true );
